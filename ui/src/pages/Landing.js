      ...
      <Box id="hero" bg="#F8EEDE" pb={100}>
        ...
        <Box ml={8} mr={8} mt={8} p={8} bg="#353935" borderRadius="20" w="40%">
          ...
          <Link as={RouterLink} to="/register" mr={4}>
            <Button bg="#93d7bf" color="#353935" size="lg" mt={4} ml={8} mb={4}>Get Started</Button>
          </Link>
        </Box>
      </Box>

      {/* About Us Section */}
      <Flex id="about" bg="#9999cc" justify="space-around" pt={20} pb={100} borderBottom="4px solid #353935" borderTop="4px solid #353935">
